...
function afegeixSegon(videos){

    const resposta = videos.map((r)=>{
        const events = r.events.map((ev,i)=>{
           return util.inspect(Object.assign({},{...ev,sec:ev.sec+i+1}))
