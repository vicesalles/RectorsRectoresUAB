...
},
{
  ...
  events:
    ...
    { id: 1, sec: 287, txt: 'Farmacòloga veterinària', tags: ['veterinària', 'facultats', 'farmacologia', 'serveis cientificotècnics'] },
    ...
    { id: 3, sec: 854, txt: 'Experiències a les administracions públiques', tags: ['govern', 'agència pública', 'ministeri', 'Europa', 'gestió'] },
    ...
    { id: 5, sec: 1757, txt: 'Noves titulacions', tags: ['titulacions', 'multidisciplinarietat', 'gènere', 'ocupabilitat', 'lletres', 'ciències', 'enginyeria', 'IA', 'A4U'] },
    { id: 6, sec: 2095, txt: '50è aniversari de la UAB', tags: ['cinquantenari', 'rankings', 'mitjans'] },
    ...
    { id: 8, sec: 2637, txt: 'Fites en recerca', tags: ['recerca', 'talent', 'personal', 'PDI', 'finançament', 'transferència', 'burocràcia', 'Parc de Recerca UAB'] },
    { id: 9, sec: 2981, txt: 'Campanyes de sensibilització', tags: ['igualtat', 'estudiants', 'sostenibilitat', 'campus', 'mobilitat', 'solidaritat'] },
    { id: 10, sec: 3529, txt: 'Mobilitzacions pel procés', tags: ['protestes', 'mobilitzacions', 'vaga', 'política','procés', 'judici'] },
    { id: 11, sec: 3946, txt: 'Clam per un finançament millor', tags: ['finançament', 'pressupost', 'economia', 'política', 'Generalitat', 'campus'] },
    { id: 12, sec: 4216, txt: 'Relació amb les altres universitats', tags: ['política', 'Hospital del Mar'] },
    { id: 13, sec: 4395, txt: 'Segona dona rectora', tags: ['dones', 'feminisme', 'igualtat', 'conciliació', 'sostre de vidre'] },
    { id: 14, sec: 4615, txt: 'Nou pla director', tags: ['comunitat', 'política', 'participació'] },
    { id: 15, sec: 4828, txt: 'ECIU University', tags: ['internacionalització', 'Europa', 'innovació', 'estudis', 'estudiants'] },
