...
},
{
  ...
  events:
    ...
    { id: 1, sec: 6, txt: 'Farmacòloga veterinària', tags: ['veterinària', 'facultats', 'farmacologia', 'serveis cientificotècnics'] },
    { id: 2, sec: 6, txt: 'Degana de la Facultat de Veterinària', tags: ['veterinària', 'facultats', 'degana', 'claustre', 'avaluació externa', 'finançament', 'govern', 'jocs olímpics'] },
    { id: 3, sec: 6, txt: 'Experiències a les administracions públiques', tags: ['govern', 'agència pública', 'ministeri', 'Europa', 'gestió'] },
    ...
    { id: 11, sec: 6, txt: 'Clam per un finançament millor', tags: ['finançament', 'pressupost', 'economia', 'política', 'Generalitat', 'campus'] },
    { id: 12, sec: 6, txt: 'Relació amb les altres universitats', tags: ['política', 'Hospital del Mar'] },
    { id: 13, sec: 6, txt: 'Segona dona rectora', tags: ['dones', 'feminisme', 'igualtat', 'conciliació', 'sostre de vidre'] },
    { id: 14, sec: 6, txt: 'Nou pla director', tags: ['comunitat', 'política', 'participació'] },
    { id: 15, sec: 6, txt: 'ECIU University', tags: ['internacionalització', 'Europa', 'innovació', 'estudis', 'estudiants'] },
    { id: 16, sec: 6, txt: 'Premi nacional per a UAB Divulga', tags: ['comunicació', 'divulgació', 'premis', 'PAS'] },
    { id: 17, sec: 6, txt: 'Pandèmia de COVID-19', tags: ['campus', 'comunitat', 'salut', 'recerca', 'estudiants'] },
    { id: 18, sec: 6, txt: 'Balanç del mandat', tags: ['balanç', 'mandat', 'rectora', 'Arboix', 'igualtat', 'metoo', 'assetjament'] },
    { id: 19, sec: 6, txt: 'Experiència com a rectora', tags: ['balanç', 'mandat', 'rectora', 'Arboix', 'transferència', 'mobilitat', 'recerca', 'transports', 'impacte social'] },
    { id: 20, sec: 6, txt: 'Anècdotes', tags: ['assetjament', 'metoo', 'igualtat'] }]
}]
